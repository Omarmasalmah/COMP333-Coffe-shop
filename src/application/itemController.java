...
public class itemController {
	...
	public void addOnAction(ActionEvent event) throws ClassNotFoundException, SQLException {
		...
		try {
			Item rc;
			rc = new Item(addName.getText(),Integer.parseInt(AddItemId.getText()),Integer.parseInt(addQuantity.getText()),AddDiscription.getText(),Double.parseDouble(AddOriginPrice.getText()),Double.parseDouble(AddSalePrice.getText())
					,Integer.parseInt(AddCatId.getText()),AddItemSize.getText());
	...
	public void getData() throws ClassNotFoundException, SQLException {
		...
		while (ResSet.next()) {
			Item i = new Item(ResSet.getString(2),ResSet.getInt(1),ResSet.getInt(5),ResSet.getString(6),ResSet.getDouble(4),ResSet.getDouble(3),
					ResSet.getInt(8),ResSet.getString(7));
			dataList.add(i);
